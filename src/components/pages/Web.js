    ...
    <div>
      ...
      <div className="container pushFooter">
        <div class="row row-padding">
          ...
          <ModalLaunchWeb image={weather} link="https://scibettas1.github.io/weather/" repo="https://github.com/scibettas1/weather" title="Weather App" description="Front-end weather application that pulls weather data by location. Created with HTML, CSS, BootStrap, JavaScript, and Open Weathermap API." alt="" />
